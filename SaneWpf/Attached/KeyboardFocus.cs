...
namespace SaneWpf.Attached
{
    public static class KeyboardFocus
    {
        ...
        public static void SetOn(UIElement element, FrameworkElement value) => element.SetValue(OnProperty, value);

        public static FrameworkElement GetOn(UIElement element) => (FrameworkElement)element.GetValue(OnProperty);
